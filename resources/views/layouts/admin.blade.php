            ...
            <div class="sidebar-inner">
                ...
                <ul class="sidebar-menu scrollable pos-r">
                    <li class="nav-item mT-30 actived"><a class="sidebar-link"
                            href="{{ route('admin.dashboard') }}"><span class="icon-holder"><i
                    ...
                    <li class="nav-item dropdown"><a class="dropdown-toggle" href="javascript:void(0);"><span
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="sidebar-link" href="{{ route('admin.listings.create') }}">Create New
                                    Listing</a></li>
                            <li><a class="sidebar-link" href="{{ route('admin.listings.index') }}">Show all Listing</a>
                            </li>
                            <li><a class="sidebar-link" href="datatable.html">Listing Tour Request</a></li>
                        </ul>
                    </li>
                    {{-- <li class="nav-item dropdown"><a class="dropdown-toggle" href="javascript:void(0);"><span
